                    ...
                    <div class="col-lg-8">
                        <div class="news-details-box-image">
                            <div class="news-details-box-image-inner">
                                ...
                                <a href="news.php" class="news-details-box-date">20 DEC</a>
                        ...
                        <div class="news-details-content-box">
                            <h4><i class="fas fa-gavel"></i> Rentrée judiciaire de la Cour de Justice de l’UEMOA</h4>
                            <p>
                                Le <strong>20 décembre 2023</strong>, la <strong>Cour de Justice de l’UEMOA</strong> a
                                organisé son audience solennelle de rentrée judiciaire à <strong>Ouagadougou</strong>.
                                Cet
                                événement majeur a réuni des hauts magistrats, des avocats et des représentants
                                institutionnels pour dresser le bilan des actions de la Cour et définir les perspectives
                                pour
                                l’année à venir.
                            </p>

                            <h5><i class="fas fa-lightbulb"></i> Points essentiels abordés :</h5>
                            <ul>
                                <i class="fas fa-gavel"></i> <strong>Bilan des affaires traitées :</strong>
                                Analyse des décisions rendues et des contentieux en cours.
                                <br>
                                <br>
                                <i class="fas fa-balance-scale"></i> <strong>Activités non judiciaires :</strong>
                                Évaluation des actions de formation et de sensibilisation menées par la Cour.
                                <br>
                                <br>
                                <i class="fas fa-handshake"></i> <strong>Renforcement de la coopération :</strong>
                                Mise en place d’un cadre de collaboration plus structuré avec les juridictions
                                nationales.
                                <br>
                                <br>
                                <i class="fas fa-book-open"></i> <strong>Évolution de la jurisprudence :</strong>
                                Adaptation aux enjeux économiques et juridiques de l’UEMOA.
                            </ul>


                            <h5><i class="fas fa-comments"></i> Discours et interventions</h5>
                            <p>
                                Lors de l’audience, le <strong>Président de la Cour</strong> a mis l’accent sur
                                l'importance
                                de la justice communautaire et a rappelé les efforts déployés pour garantir un meilleur
                                accès
                                au droit dans l’espace UEMOA.
                            </p>
                            <p>
                                Des représentants des Barreaux et des institutions partenaires ont également pris la
                                parole
                                pour souligner la nécessité d’une justice plus accessible et transparente.
                            </p>

                            <p>
                                Cette rentrée judiciaire marque une étape clé dans le renforcement du système judiciaire
                                communautaire et dans la protection des droits fondamentaux au sein de l’Union.
                            </p>
