				...
				<div class="row row-gutter-y-40">
					<div class="col-xl-2 col-lg-4 col-md-6">
						<div class="department-card">
							...
							<div class="department-card-content">
								<h5><a href="department-details.html">Administration</a></h5>
					...
					<div class="col-xl-2 col-lg-4 col-md-6">
						<div class="department-card">
							...
							<div class="department-card-content">
								<h5><a href="department-details.html">Offres d'emploi</a></h5>
							</div><!-- department-card-content -->
						</div><!--department-card-->
					</div><!--col-xl-2 col-lg-4 col-md-6-->
					<div class="col-xl-2 col-lg-4 col-md-6">
						<div class="department-card">
							...
							<div class="department-card-content">
								<h5><a href="department-details.html">Economie</a></h5>
							</div><!-- department-card-content -->
						</div><!--department-card-->
					</div><!--col-xl-2 col-lg-4 col-md-6-->
					<div class="col-xl-2 col-lg-4 col-md-6">
						<div class="department-card">
							...
							<div class="department-card-content">
								<h5><a href="department-details.html">Routes & Transport</a></h5>
							</div><!-- department-card-content -->
						</div><!--department-card-->
					</div><!--col-xl-2 col-lg-4 col-md-6-->
					<div class="col-xl-2 col-lg-4 col-md-6">
						<div class="department-card">
							...
							<div class="department-card-content">
								<h5><a href="department-details.html">Culture</a></h5>
							</div><!-- department-card-content -->
						</div><!--department-card-->
					</div><!--col-xl-2 col-lg-4 col-md-6-->
					<div class="col-xl-2 col-lg-4 col-md-6">
						<div class="department-card">
							...
							<div class="department-card-content">
								<h5><a href="department-details.html">Sécurité</a></h5>
							</div><!-- department-card-content -->
						</div><!--department-card-->
					</div><!--col-xl-2 col-lg-4 col-md-6-->
				</div><!-- row -->
				...
				<div class="col-lg-6">
					<div class="about-image">
						<div class="about-image-inner img-one">
							...
							<div class="sign-text">Mr DIANÉ</div><!-- sign-text -->
							<div class="about-image-caption">
								<div class="about-image-caption-inner">
									<span class="about-caption-number">10</span>
									<span class="about-caption-text">ans<br>d'experience</span>
				...
				<div class="col-lg-6">
					<div class="about-inner">
						<div class="section-title-box">
							<div class="section-tagline">Presentation</div><!-- section-tagline -->
							<h2 class="section-title">Bienvenue sur le portail de la commune de Jaxaay-Parcelles</h2>
							<p>Vous trouverez dans ce portail.............</p>
						</div><!-- section-title-box -->
						<div class="row">
							<div class="col-xl-6 col-lg-12 col-md-6">
								<div class="about-card">
									<h4 class="about-title"><i class="fa-solid fa-circle-check"></i>Demarches en ligne</h4>
									<p class="about-text">Lorem ipsum dolor sited amet consectetur notted.</p>
								</div><!-- about-card -->
							</div><!-- col-xl-6 col-lg-12 col-md-6 -->
							<div class="col-xl-6 col-lg-12 col-md-6">
								<div class="about-card">
									<h4 class="about-title"><i class="fa-solid fa-circle-check"></i>Les commissions</h4>
									<p class="about-text">Lorem ipsum dolor sited amet consectetur notted.</p>
								</div><!-- about-card -->
							</div><!-- col-xl-6 col-lg-12 col-md-6 -->
						</div><!--row-->
				...
				<div class="row row-gutter-y-40">
					...
					<div class="col-xl-7">
						...
						<div class="event-card">
							<div class="event-card-image">
								<div class="event-card-image-inner">
									<a href="event-details.html"><img src="assets/image/event/event-3.jpg" class="img-fluid" alt="img-21"></a>
									<div class="event-card-meta">
										<div class="event-meta-number">
											<span>28</span>
										</div><!-- event-meta-number -->
