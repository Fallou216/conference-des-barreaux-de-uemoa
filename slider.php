					...
					<div class="row">
						<div class="col-md-12">
							<div class="slider-content">
								<div class="slider-tagline">Mairie de Jaxaay Parcelles</div>
								<h1 class="section-title">Keur Massar</h1>
								<a href="index-2.html" class="btn btn-primary">Decouvrir</a>
							</div><!-- slider-content -->
						</div><!-- col-md-12 -->
					</div><!-- row -->
				</div><!-- container -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="slider-content">
								<div class="slider-tagline">Mairie de Jaxaay Parcelles</div>
								<h1 class="section-title">Jaxaay Parcelles <br>Keur Massar</h1>
								<a href="index-2.html" class="btn btn-primary">Decouvrir</a>
							</div><!-- slider-content -->
						</div><!-- col-md-12 -->
					</div><!-- row -->
